        ...
        <div className={style.contenedorForm}>
            <form action="https://formsubmit.co/ledangom@gmail.com" method="POST">
                <div className={style.mitad}>
                    <input type="text" placeholder="Nombre Completo" className={style.fila} name="name"/>
                </div>
                <div className={style.mitad}>
                    <input type="text" placeholder="Direccion de Email" className={style.fila} name="email"/>
                </div>
